...
public class HumanBeing {
    ...
    public void setCoordx(Scanner in, Boolean check) throws CollectionException{
        try {
            if (check) {
                System.out.print("x (Integer, < 575): ");
            }
            String value;
            value = in.nextLine();
            if (equals("", value)){
    ...
    public void setRealHero(Scanner in, Boolean check) throws CollectionException{
        try {
            ...
            else if (!Comand.looseEquals(value, "true") && !Comand.looseEquals(value, "false")){
    ...
    public void setWeaponType(Scanner in, Boolean check) throws CollectionException{
        try {
            ...
            this.weaponType = Comand.getWeapon(type);
        }
        catch(NullException n){
            if (check){
                System.out.println(n.getMessage());
                ...
                throw new CollectionException("No value entered for variable weaponType.");
            }
        }
        catch(TypeException t){
            if (check){
    ...
    public void setMood(Scanner in, Boolean check) throws CollectionException{
        try{
            ...
            if (check){
                ...
                throw new CollectionException("No value entered for variable mood.");
            }
        }
        catch(TypeException t){
            if (check){
    ...
    public void setCarCool(Scanner in, Boolean check) throws CollectionException{
        try {
            ...
            if (check){
                ...
                throw new CollectionException("No value entered for variable Car.cool.");
            }
        }
        catch(TypeException t){
            if (check){
